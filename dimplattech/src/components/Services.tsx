        ...
        <section className="px-[5%] my-20">
            ...
            <div className="flex flex-wrap gap-[3vw] sm:gap-[4.5vw] sm:justify-center xl:justify-start xl:gap-[2.75%]">
                <Service 
                    image={image1}
                >
                    <p className="text-2xl font-semibold text-[#219dd0] mb-3 h-[64px]">In-depth Training<br /> and Mentorship</p>
                ...
                <Service
                    image={image2} 
                >
                    <p className="text-2xl font-semibold text-[#219dd0] mb-3 h-[64px]">Great  Learning<br /> Environment</p>
                    <p className="text-base text-[#4d4d4d]">
                ...
                <Service
                    image={image3}
                >
                    <p className="text-2xl font-semibold text-[#219dd0] mb-3 h-[64px]">Internship Placements</p>
                    <p className="text-base text-[#4d4d4d]">
